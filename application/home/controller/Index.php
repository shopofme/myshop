...
class Index extends Base {
    ...
    public function index(){      
        ...
        if(empty($index_hot_goods))
        {
            ...
            S('index_hot_goods',$index_hot_goods,MYSHOP_CACHE_TIME);
        }
        ...
        if(empty($index_recommend_goods))
        {
        	...
        	S('index_recommend_goods',$index_recommend_goods,MYSHOP_CACHE_TIME);
        }
        ...
        $hot_category = M('goods_category')->where("is_hot=1 and level=3 and is_show=1")->cache(true,MYSHOP_CACHE_TIME)->select();//热门三级分类
    ...
    public function qr_code_raw(){        
        ...
        //http://localhost/Home/Index/erweima/data/www.99soubao.com
    ...
    /*function truncate_tables (){
        ...
        {                                    
            if(!in_array($val['Tables_in_shop2.0'], $table))
                echo "truncate table ".$val['Tables_in_shop2.0'].' ; ';
                echo "<br/>";         
        }                
    }*/
    ...
    public function ajax_favorite(){
        ...
        $favourite_goods = Db::name('goods')->where($where)->order('goods_id DESC')->page($p,$i)->cache(true,MYSHOP_CACHE_TIME)->select();//首页推荐商品
