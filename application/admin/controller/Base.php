...
class Base extends Controller {
    ...
    {
        Session::start();
        header("Cache-control: private");  // history.back返回后输入框值丢失问题 参考文章   http://blog.csdn.net/qinchaoguang123456/article/details/29852881
        parent::__construct();
    ...
    public function public_assign()
    {
       ...
       $my_config = M('config')->cache(true)->select();
