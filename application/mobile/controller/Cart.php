...
class Cart extends MobileBase {
    ...
    public function index(){
        ...
        $hot_goods = M('Goods')->where('is_hot=1 and is_on_sale=1')->limit(20)->cache(true,MYSHOP_CACHE_TIME)->select();
    ...
    public function cart2(){
        ...
        $shippingList = M('Plugin')->where("`type` = 'shipping' and status = 1")->cache(true,MYSHOP_CACHE_TIME)->select();// 物流公司
    ...
    public function integral(){
        ...
        $shippingList = Db('Plugin')->where("`type` = 'shipping' and status = 1")->cache(true,MYSHOP_CACHE_TIME)->select();// 物流公司
